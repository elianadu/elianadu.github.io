...
ICONS = {
    ...
    "Meet with me": '<path d="M19 3h-1V1h-2v2H8V1H6v2H5C3.9 3 3 3.9 3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z"/>',
...
ICON_ORDER = ["Email", "Meet with me", "LinkedIn", "GitHub", "Substack", "Curius"]
ICON_HREFS = {
    "Meet with me": "https://cal.com/elianadu",
...
DEFAULT_BODY = {
    ...
    "contact": """    <p>The best way to reach me is by email — click the Email button to copy my address. You're also welcome to <a class="il" href="https://cal.com/elianadu" target="_blank" rel="noopener">book a meeting</a>.</p>
...
def rail_html():
    ...
    for name in ICON_ORDER:
        ...
        if name == "Email":
            links.append(
                '        <li class="tipwrap"><button type="button" id="emailBtn" aria-describedby="emailTooltip">%s%s</button>'
                '<span class="tip" id="emailTooltip" role="tooltip">Click to copy</span></li>' % (icon, name)
            )
        else:
            links.append(
...
%s
    ...
    <aside class="rail">
      <div class="frame">
        <div class="inner">
          <img class="photo" src="images/me_by_nassau_hall.jpg" alt="Eliana Du" />
          <img class="photo-gif" src="images/me_illustrated.gif" alt="" aria-hidden="true" />
        </div>
      </div>
